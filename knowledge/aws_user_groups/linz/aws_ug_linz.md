...
- **Meetup Schedule**: The AWS User Group Linz meets **quarterly**.
- **Event Duration**: Typically **from 17:00 to Open End**
- **Venue**: Changes based on sponsors
...
- **Event Format**:
  ...
  - **18:00 - 18:10**: Welcome & Introduction AWS User Group Linz (UG Leader gives intro, community news)
